...
#    include "options.h"
#    include "output.h"
#    include "overmap/note_label_utils.h"
#    include "overmap/overmap_label.h"
#    include "overmap/overmap_label_note.h"
...
{
    std::string version = string_format( "Cataclysm: Slop Edition - %s", getVersionString() );
